...
const OrderTracking = () => {
  ...
  return (
    <div className="pt-16">
      ...
      <div className="relative h-80 bg-cover bg-center flex items-center justify-center bg-[url('https://images.pexels.com/photos/163030/pexels-photo-163030.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')]">
